...
class Searching:
    def __init__(self, root, AlgoNameVar):
        ...
        self.WINDOW_X, self.WINDOW_Y = (self.wxs / 2) - (self.wx /
                                                         2), (self.wys / 2) - (self.wy / 2)
        ...
        self.algo_menu.config(font="calibri", bg="cyan",
                              activebackground="sandy brown", cursor="arrow")
        ...
        self.frame_btn1.place(relx=0.05, rely=0.14)
        ...
        self.btn_new.place(relx=0.13, rely=0.1)
        ...
        self.btn_shuffle.place(relx=0.55, rely=0.1)

        # text box for search entry
        self.search_element = Entry(self.frame1, width=27, bd=3, bg='cyan')
        ...
        self.frame_btn2 = Frame(self.frame1, width=230, height=40, bg="gray")
        self.frame_btn2.grid_propagate(0)
        self.frame_btn2.place(relx=0.05, rely=0.28)
        # Creating a search button
        self.btn_sort = Button(self.frame_btn2, text="Search", padx=13, pady=3, command=self.search_list,
                               bg="SteelBlue3", fg="azure", cursor="hand2")
        self.btn_sort.place(relx=0.36, rely=0.1)
        ...
        self.label_comparison = Label(self.frame1, text="No. of comparisons: 0", bg="gray2", fg="snow",
                                      font=("Fixedsys", 15))
        self.label_comparison.place(relx=0.08, rely=0.68)

        # Label for showing the searched element index
        self.label_index = Label(self.frame1, text="", bg="gray2", fg="snow",
                                 font=("Fixedsys", 15))
        self.label_index.place(relx=0.2, rely=0.58)

        # Back button to the main window
        self.BackButton = Button(self.frame1, bg="yellow", fg="RoyalBlue4", text="< Go back to main window",
                                 command=self.Back, font=("calibri", 12, "bold"), cursor="hand2")
        ...
        self.canva = Canvas(self.frame2, width=self.CANVAS_X,
                            height=self.CANVAS_Y, bg="light blue")
        self.canva.pack()
        ...
        for num in self.numbers:
            ...
            self.label_value = Label(self.canva, text=num, bg="sandy brown",
                                     fg="midnight blue", font=("Fixedsys", 12))
            self.canva.create_window(self.starting_point + 16,
                                     self.CANVAS_Y - num + 12, window=self.label_value)
